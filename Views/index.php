                                    ...
                                    <div class="card-body">
                                        <form id="frmLogin">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="usuario" name= "usuario" type="email" placeholder="Ingrese usuario" />
                                            </div>
                                            <div class="form-group">
                                                <label class="small mb-1" for="clave"><i class="fas fa-key"></i>Contraseña</label>
                                                <input class="form-control py-4" id="clave" name = "clave" type="password" placeholder="Ingrese la contraseña" />
                                            </div>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; <a href= "http://angelsifuentes.com"> Visite mi pagina web</a> <?php echo date("Y"); ?></div>
                            <div>
